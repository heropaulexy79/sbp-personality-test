<section class="bg-primary py-20 text-primary-foreground">
    <div class="mx-auto max-w-2xl p-8 text-center">
        ...
        <form action="/signup"
            class="mx-auto mt-4 flex max-w-md gap-2 rounded-md bg-background px-3 py-2 ring-offset-background focus-within:outline-hidden focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
            <div class="flex-1">
                <input type="email" name='email'
                    class="flex h-10 w-full rounded-md border-0 bg-background px-0 py-2 text-sm outline-hidden file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-transparent disabled:cursor-not-allowed disabled:opacity-50"
