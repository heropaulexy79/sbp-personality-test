...
<body class="font-sans antialiased">
    ...
    <img id="background" class="pointer-events-none absolute inset-0 h-screen w-full object-cover"
    ...
    <div class="relative min-h-screen">
        <header class="">
            <div class="container grid grid-cols-2 items-center gap-2 border-b border-black/5 py-4 lg:grid-cols-2">
                <div>
                    <a href="/">
                        <img src="{{ asset('images/logo_001-white.svg') }}" alt="logo" class="max-h-12" />
                    </a>
                </div>
        ...
        <main class="mt-6">
            <div class="mx-auto mt-40 max-w-2xl p-8 text-center">
                <h1 class="text-4xl font-bold text-[hsla(252,100%,14%,1)]">Learn a Course on Culture</h1>
                <p class="mt-2 text-lg text-gray-700">Lorem ipsum dolor sit amet consectetur. Odio sed varius
