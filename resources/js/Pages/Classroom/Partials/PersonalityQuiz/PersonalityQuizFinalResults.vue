...
<template>
  <Card v-if="Boolean(topTraitResult)" class="w-full">
    ...
    <CardContent class="space-y-10">
      <Card
        class="border-primary/20 from-primary/10 to-primary/20 border-2 bg-gradient-to-r"
      >
        <CardHeader>
        ...
        <CardContent>
          <div class="space-y-4">
            <div
              class="border-primary/50 bg-primary-foreground/70 rounded-lg border p-4"
            >
              <p class="text-primary mb-3 text-sm font-medium">
                Share message:
              </p>
              <p class="text-primary font-medium">{{ shareMessage }}</p>
            </div>
      ...
      <!-- Course -->
      <Card
        class="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 transition-all duration-300 hover:shadow-lg"
      >
        <CardHeader>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex items-center justify-end gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="bg-purple-600 transition-all hover:scale-105 hover:bg-purple-700"
